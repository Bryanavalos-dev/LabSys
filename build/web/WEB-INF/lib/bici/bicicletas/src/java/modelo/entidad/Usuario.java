...
public class Usuario  implements java.io.Serializable {
    ...
    public Usuario(Sucursal sucursal, String nombre, String clave, String nombreCompleto, Boolean activo, Date fechaCreacion, Set<Cliente> clientes, Set<Alquiler> alquilers) {
