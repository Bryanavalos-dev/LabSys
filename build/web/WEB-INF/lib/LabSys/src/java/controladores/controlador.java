             ...
             case "login":
                 ...
                 if(l.login()){
                     ...
                     if(u.getIdrol()==1){
                      ...
                      if(u.getIdrol()==2){
                         RequestDispatcher mostrar = request.getRequestDispatcher("vistas/encargado/encargado.jsp");
                         request.setAttribute("mensaje","Bienvenido encargado");
                         mostrar.forward(request, response);
                     }
                        if(u.getIdrol()==3){
                         RequestDispatcher mostrar = request.getRequestDispatcher("vistas/ordenanza/ordenanza.jsp");
                         request.setAttribute("mensaje","Bienvenido ordenanza");
                         mostrar.forward(request, response);
                     }
                      else{
